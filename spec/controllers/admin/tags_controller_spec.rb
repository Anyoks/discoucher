  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Admin::Tag" do
        expect {
          post :create, params: {admin_tag: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create, params: {admin_tag: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested admin_tag" do
        tag = Admin::Tag.create! valid_attributes
        put :update, params: {id: tag.to_param, admin_tag: new_attributes}, session: valid_session
        tag.reload
      ...
      it "redirects to the admin_tag" do
        tag = Admin::Tag.create! valid_attributes
        put :update, params: {id: tag.to_param, admin_tag: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        tag = Admin::Tag.create! valid_attributes
        put :update, params: {id: tag.to_param, admin_tag: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end

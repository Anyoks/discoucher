class Mpesa
  ...
  LIVE_PASSWORD = 'NTM5MzA0YmZiMjc5ZjlhYTliZGJjZjE1OGU5N2RkNzFhNDY3Y2QyZTBjODkz\nMDU5YjEwZjc4ZTZiNzJhZGExZWQyYzkxOTIwMTgwODE0MDg1NjIw'
  LIVE_TIMESTAMP = '20180814085620'
  LIVE_SHORTCODE = '885582'
  LIVE_PASSKEY = 'bfb279f9aa9bdbcf158e97dd71a467cd2e0c893059b10f78e6b72ada1ed2c919'
  ...
  def request_live_mpesa_api
    ...
    request.body = "{\"BusinessShortCode\": \"#{LIVE_SHORTCODE}\",
      ...
      \"Amount\": \"#{amount}\",
      \"PartyA\": \"#{phone_number}\",
      \"PartyB\": \"#{LIVE_SHORTCODE}\",
      \"PhoneNumber\": \"#{phone_number}\",
      \"CallBackURL\": \"http://159.89.103.53/api/v1/pay/from_mpesa\",
      \"AccountReference\": \"disc\",
      \"TransactionDesc\": \"pay\"}"

...
class VouchersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create voucher" do
    assert_difference('Voucher.count') do
      post vouchers_url, params: { voucher: { code: @voucher.code, condition: @voucher.condition, description: @voucher.description, year: @voucher.year } }
    end
  ...
  test "should update voucher" do
    patch voucher_url(@voucher), params: { voucher: { code: @voucher.code, condition: @voucher.condition, description: @voucher.description, year: @voucher.year } }
